...
function setPageTitle() {
  ...
  const spanNode = pageTitle.querySelector('.name');
  spanNode.textContent = 'Roger Rabbit';
}
...
function displayReviews() {
  ...
  addReviewer(container, "Roger Rabbit");
  addTitle(container, "Book title");
  addReview(container, "Stuff the reviewer said");
  addRating(container, 3);
