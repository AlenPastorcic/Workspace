...
public class Exercise03_ShippingTotal {
    ...
    public double calculateShippingTotal(int weightPounds) {
        double shippingTotal = calculateShippingRate(weightPounds);
        return shippingTotal * weightPounds;
    }
    ...
    public double calculateShippingTotal(int weightPounds, boolean hasDiscount) {
        ...
        if (weightPounds > 40) {
            shippingRate = 0.75;
            shippingTotal = shippingRate * weightPounds;
        } else {
        ...
        if (hasDiscount) {
            shippingTotal = (0.90) * shippingRate * weightPounds;
        }
