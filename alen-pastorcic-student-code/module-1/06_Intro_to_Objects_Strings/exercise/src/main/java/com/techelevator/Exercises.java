...
public class Exercises {
	...
	public String nonStart(String a, String b) {
		String mike = a.substring(1);
		String el = b.substring(1);
	...
	public String left2(String str) {
		String joey = str.substring(0,2);
		String chandler = str.substring(2) + joey;
	...
	public String right2(String str) {
		...
		String right3 = right2 + str.substring(0, str.length() - 2);
		return right3;
	}
	...
	public String theEnd(String str, boolean front) {
		String theEnd;
		if (front == false) {
			theEnd = str.substring(str.length() - 1);
		}
		else {
	...
	public String twoChar(String str, int n) {
		if (n < 0 || n > str.length() - 2) {
			...
			return str.substring(n, Math.min(n + 2, str.length()));
		}
	...
	public String middleThree(String str) {
		...
		return str.substring(middleWord - 1, middleWord + 2);
